...
def main():
    ...
    image_types = [["All Images", "Full Color", "Blue", "Red", "Near Infrared", "Cirrus", "Snow/Ice", "Cloud Particle Size", "Thermal", "Upper-level water vapor", "Mid-level water vapor", "Lower-level water vapor", "Cloud-top", "Ozone-level", "Infrared-less sensitive", "Infrared", "Infrared-sensitive", "Carbon Dioxide"],
                   ["", "_FC_", "_1_", "_2_", "_3_", "_4_", "_5_", "_6_", "_7_", "_8_", "_9_", "_10_", "_11_", "_12_", "_13_", "_14_", "_15_", "_16_"]]
    ...
    output_type = st.sidebar.selectbox("Select a display type", ["Timelapse", "Images"])
    ...
    if output_type == "Timelapse":
        st.subheader("Timelapse GIF")
        create_timelapse(folder_selected, file_image_type)

    if output_type == "Images":
        st.subheader("Images")
        image_files.sort(key=os.path.getmtime, reverse=True)  # Sort by last modified time, latest first
        button_key = 1
